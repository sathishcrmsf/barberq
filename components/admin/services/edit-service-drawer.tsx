// @cursor: Multi-step service editing drawer
// Guided 5-step workflow: Category → Details → Staff → Settings → Review
// Pre-populates with existing service data
...
export function EditServiceDrawer({ isOpen, onClose, service, onSuccess }: EditServiceDrawerProps) {
  ...
  const handleSubmit = async () => {
    if (!validateStep(2) || !service) return; // Validate required fields
            ...
            {currentStep === 2 && (
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Update the basic information about this service.
                  </p>
                </div>
            ...
            {currentStep === 5 && (
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Please review all the details before updating the service.
                  </p>
                </div>
